...
void clearLog()
{
    ...
    pthread_mutex_lock(&outputLock); /* Wait until the output file is avaliable. */
    /* CRITICAL SECTION */
    ...
    pthread_mutex_unlock(&outputLock); /* Release the output file to be used by other processes. */
